...
## Phase 4: Real-Time Operating Systems (RTOS)
### Priority Inversion, Inheritance, and Binary Semaphores

---

## 🏛️ Section 1: Architectural Week Alignment & Reference Manifest

*   **Target Phase:** Phase 4: Real-Time Operating Systems (RTOS)
*   **Target Week:** Week 21
*   **Hardware Anchor:** NVIC priority register overrides, Semaphore lock structures, and task priority inheritance matrices
*   **Documentation Map:**
...
*   📘 **Theory Deep-Dive (4 Hours):** Detailed analysis of first-principles core mechanics and register bitfield layouts for Priority Inversion, Inheritance, and Binary Semaphores.
...
```c
// Direct register configurations for Priority Inversion, Inheritance, and Binary Semaphores
#include <stdint.h>
...
1.  **Challenge 1:** How does high execution clock frequency affect register propagation latency during Priority Inversion, Inheritance, and Binary Semaphores?
