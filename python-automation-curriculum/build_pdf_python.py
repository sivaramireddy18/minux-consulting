...
CORE_FILES = [
    "README.md",
    "python-trainer-rules.md",
    "12-week-python-roadmap.md",
    "python-milestone-scorecard.md"
]

# Path configurations
CURRICULUM_DIR = "/home/siva/sivaramireddy/Project1/python-automation-curriculum"
PLANS_DIR = os.path.join(CURRICULUM_DIR, "plans")
HTML_OUT = os.path.join(CURRICULUM_DIR, "professional-python-automation-curriculum.html")
PDF_OUT = os.path.join(CURRICULUM_DIR, "professional-python-automation-curriculum.pdf")

# Custom print CSS stylesheet for professional paged media layout
# Sleek Python deep systems-blue (#1E3A8A) and gold-amber (#D97706) design palette
CSS_STYLE = """
...
@page {
    ...
    @bottom-left {
        content: "Python in Embedded & Automation Framework Design | Senior Automation Architect";
        font-family: 'Outfit', sans-serif;
        font-size: 8pt;
        color: #64748b;
        font-weight: 500;
...
def main():
    ...
    print("Merging Python curriculum files in sequence...")
    ...
    <div class="cover-page">
        <div class="cover-title">PYTHON FOR EMBEDDED &<br>AUTOMATION FRAMEWORK DESIGN</div>
        <div class="cover-subtitle">A Rigorous, First-Principles Hardware-in-the-Loop Test Suite Curriculum</div>
        <div class="cover-meta">
            <strong>Duration:</strong> 12 Weeks | <strong>Level:</strong> Advanced Automation<br>
            <strong>Mentor:</strong> Senior Automation Architect & Coach<br>
            <strong>Workspace Root:</strong> /home/siva/sivaramireddy/Project1/python-automation-curriculum/
        </div>
    </div>
    """)
    ...
    for w in range(1, 13):
        week_file = f"week-{w:02d}-python-plan.md"
...
<head>
    <meta charset="utf-8">
    <title>Professional Python Embedded & Automation Curriculum</title>
    <style>
    {CSS_STYLE}
    </style>
</head>
...
"""
    ...
    try:
        ...
        print(f"SUCCESS: Professional Python PDF generated at: {PDF_OUT}")
