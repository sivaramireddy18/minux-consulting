...
MD_IN = "/home/siva/.gemini/antigravity-cli/brain/e9894df3-8589-4519-a585-3139faf09174/mini_projects_catalog.md"
HTML_OUT = os.path.join(WORKSPACE, "mini_projects_catalog.html")
PDF_OUT = os.path.join(WORKSPACE, "mini_projects_catalog.pdf")

# Custom print CSS stylesheet for professional paged media layout
# Dynamic systems-amber (#D97706) and deep slate (#0F172A) design palette
CSS_STYLE = """
...
@page {
    ...
    @bottom-left {
        content: "Systems Engineering 15 Mini-Projects Catalog | Technical Director";
        font-family: 'Outfit', sans-serif;
        font-size: 8pt;
        color: #64748b;
        font-weight: 500;
...
def main():
    ...
    print("Compiling 15 Mini-Projects Catalog in sequence...")
    ...
    <div class="cover-page">
        <div class="cover-title">15 SYSTEMS ENGINEERING<br>MINI-PROJECTS CATALOG</div>
        <div class="cover-subtitle">Targeted, Weekly-Scale Technical Exercises with MNC Jira Checklists</div>
        <div class="cover-meta">
            <strong>Scope:</strong> Low-level C, register-level FreeRTOS & Python HIL test scripts<br>
            <strong>Author:</strong> Senior Systems Architect & Coach<br>
...
<head>
    <meta charset="utf-8">
    <title>15 Systems Engineering Mini-Projects Catalog</title>
    <style>
    {CSS_STYLE}
    </style>
</head>
...
"""
    ...
    try:
        ...
        print(f"SUCCESS: 15 Mini-Projects Catalog PDF generated at: {PDF_OUT}")
